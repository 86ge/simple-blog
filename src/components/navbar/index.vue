<template>
      ...
      <el-row >
        ...
        <el-col :span="12" justify="center">
          <el-tabs  stretch v-model="activeName" class="demo-tabs hidden-xs-only tabhead" @tab-click="handleClick">
            <el-tab-pane label="文章" name="index"></el-tab-pane>
            <el-tab-pane v-if="isLogin" label="我的"  name="mine"></el-tab-pane>
      ...
      <el-row >
        ...
        <el-col :span="6" justify="space-evenly" :class="windowWidth?'box':''">
          <div style="display: flex;justify-content: space-evenly">
            <div style="display: inline-block"><Login-reg ></Login-reg></div>
            <el-icon @click="showMask" class="hidden-sm-and-up" :color="'#409EFF'" style="float: right" :size="'8vw'"><Grid  /></el-icon>
          </div>
        </el-col>
      </el-row>
    </template>
  ...
  <el-drawer
    ...
    size="auto"
  >
    <template v-for="item of menuMsg">
