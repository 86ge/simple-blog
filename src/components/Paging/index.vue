<template>
  ...
  <div  v-if="windowWidth > 600 && dateCount > 10"
...
const handleScroll = () => {
  ...
  if((scrollTop + clientHeight >= scrollHeight - 200)&&dateCount.value>10&&currentPage.value*10<dateCount.value){
    currentPage.value++
  }
}
...
onMounted(()=>{
  ...
  props.callback({pageSize:10,pageIndex:1}).then((res: any) => {
